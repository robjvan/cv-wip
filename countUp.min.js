...
t[p]=s[p]}
return t};return __assign.apply(this,arguments)};var CountUp=(function(){function CountUp(target,endVal,options){var _this=this;this.target=target;this.endVal=endVal;this.options=options;this.version='2.0.4';this.defaults={startVal:0,decimalPlaces:0,duration:2,useEasing:!0,useGrouping:!0,smartEasingThreshold:999,smartEasingAmount:333,separator:',',decimal:'.',prefix:'',suffix:''};this.finalEndVal=null;this.useEasing=!0;this.countDown=!1;this.error='';this.startVal=0;this.paused=!0;this.count=function(timestamp){if(!_this.startTime){_this.startTime=timestamp}
...
if(this.finalEndVal){this.useEasing=!1}
else{this.useEasing=this.options.useEasing}};CountUp.prototype.start=function(callback){if(this.error){return}
this.callback=callback;if(this.duration>0){this.determineDirectionAndSmartEasing();this.paused=!1;this.rAF=requestAnimationFrame(this.count)}
